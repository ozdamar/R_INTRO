...
[More R Games:](https://lucidmanager.org/tags/r-games/)
...
Object         | `class()`    |  `mode()`   |  `typeof()` | `storage.mode()`
---------------|--------------|-------------|-------------|---------------
...
[Objects in R](https://cran.r-project.org/doc/manuals/r-release/R-lang.html#Objects)
